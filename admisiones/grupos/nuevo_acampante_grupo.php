<?php
// admisiones/grupos/nuevo_acampante_grupo.php
...
if (!$grupo_id) { header('Location: lista_grupos.php'); exit(); }
...
if ($_POST) {
    try {
        ...
        registrarLog($pdo, 'acampante_grupo_agregado',
            "Acampante '{$nombre}' agregado al grupo {$grupo_id}", 'admisiones', 'success');
        header("Location: ver_grupo.php?id={$grupo_id}&message=" .
            urlencode("✅ Acampante '{$nombre}' agregado"));
        exit();
    } catch (Exception $e) {
        $error = $e->getMessage();
    }
...
<div class="row mb-4">
    <div class="col-12">
        <h1>
            ...
            Agregar Acampante —
            <span class="text-primary"><?= htmlspecialchars($grupo['nombre']) ?></span>
        </h1>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="iglesia"
                       value="<?= htmlspecialchars($_POST['iglesia'] ?? $grupo['nombre']) ?>">
            </div>
            <div class="col-md-3 d-flex align-items-end mb-1">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox"
                           name="asiste_iglesia" id="asiste_ig" checked>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="cont_nombre"
                       value="<?= htmlspecialchars($_POST['cont_nombre'] ?? '') ?>"
                       placeholder="Nombre">
            </div>
            <div class="col-md-6">
